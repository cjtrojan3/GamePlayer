...
public interface TwoPlayerGameBoard {
	...
	public TwoPlayerGameBoard nextChild();		// returns the next feasible child board (note that we have combined nextChild and isFeasible into this method)
	...
	public void placeUserMove(Point2D mouseLocation) throws Exception; 	
												// mutates the current problem to
